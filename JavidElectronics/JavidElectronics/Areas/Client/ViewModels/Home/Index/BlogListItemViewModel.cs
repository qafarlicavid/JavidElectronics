...
namespace JavidElectronics.Areas.Client.ViewModels.Home.Index
{
    ...
    {
        public BlogListItemViewModel(int id, string name, string mainImageUrl, string hoverImageUrl, string videoURL, string adminName, DateTime createdAt, string content)
        {
            Id = id;
            Name = name;
